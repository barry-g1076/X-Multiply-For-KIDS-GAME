...
function AddData() {
  player["First Name"] = document.getElementById("FName").value;
  player["Last Name"] = document.getElementById("LName").value;
  player.email = document.getElementById("EMail").value;
  player.DOB = document.getElementById("date").value;
